...
public class ChaveAcessoNFEOriginal {  
    ...
    public static void main(String[] args) {  
        try {  
            ...
            String dataAAMM = "1906"; // Ano e Mês de emissão da NF-e.  
            String cnpjCpf = "03.258.870/0001-53"; // CNPJ do emitente.  
            String mod = "55"; // Modelo do Documento Fiscal.  
            String serie = "1"; // Série do Documento Fiscal.  
            String tpEmis = "1"; // Forma de emissão da NF-e  
            String nNF = "127377"; // Número do Documento Fiscal.  
            String cNF = "64690"; // Código Numérico que compõe a Chave de Acesso
